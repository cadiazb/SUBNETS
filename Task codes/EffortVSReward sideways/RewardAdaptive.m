...
%% temp rotate screen
b5.ProbeEffortTarget_pos 		= b5.ProbeEffortTarget_pos(2:-1:1);
b5.ProbeEffortAxis_pos          = b5.ProbeEffortAxis_pos(2:-1:1); 


b5.ReferenceTarget_pos 		= b5.ReferenceTarget_pos(2:-1:1);
b5.ReferenceAxis_pos          = b5.ReferenceAxis_pos(2:-1:1); 


b5.StartTarget_pos                  = b5.StartTarget_pos(2:-1:1);
b5.StartAxis_pos                    = b5.StartAxis_pos(2:-1:1);


b5.ProbeEffortTarget_scale 		= b5.ProbeEffortTarget_scale(2:-1:1);


b5.ReferenceTarget_scale 		= b5.ReferenceTarget_scale(2:-1:1);


b5.StartTarget_scale                  = b5.StartTarget_scale(2:-1:1);


%% Set reward string position
b5.ProbeRewardString_pos        = (b5.ProbeEffortTarget_pos - ...
                            (-1)^dat.ProbeEffortUp * [100 0]) + ...
                            [120 65];
...
b5.ProbeEffortString_pos        = (b5.ProbeEffortTarget_pos- ...
                            (-1)^dat.ProbeEffortUp * [0 0]) + ...
                            [120, 64];
b5.ReferenceEffortString_pos    = (b5.ReferenceTarget_pos + ...
                            (-1)^dat.ProbeEffortUp * [0 0]) + ...
                            [120, 64];

...
b5.RewardFeedback_pos = b5.RewardCircleFeedback_pos - [Params.StringOffset(1),0];
...
if ~dat.OutcomeID
    ...
    [Params, b5] = moveShape(Params, b5, {'RewardCircle', 'Reward'}, ...
        [Params.WsCenter;Params.WsCenter] + [-60, b5.Frame_scale(2)/2; -60, b5.Frame_scale(2)/2], [0 0;-20 0],[0 0;-Params.StringOffset(1) 0]);
